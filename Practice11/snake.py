...
current_food = generate_food(snake_body)
...
while True:
    ...
    if snake_pos[0] == current_food['pos'][0] and snake_pos[1] == current_food['pos'][1]:
    ...
    if current_food['lifespan'] > 0:
        current_time = pygame.time.get_ticks()
        if current_time - current_food['spawn_time'] > current_food['lifespan']:
            current_food = generate_food(snake_body)
